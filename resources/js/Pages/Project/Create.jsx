                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            >
                                <div>
                                    <InputLabel htmlFor="project_image_path" value="Image Path"/>
                                    <TextInput
                                ...
                                <div className="mt-4">
                                    ...
                                    onChange={(e) => setData('status', e.target.value)}>
                                        <option value="pending">Pending</option>t
                                        <option value="in_progress">In Progress</option>t
                                        <option value="completed">Completed</option>t
                                    </SelectInput>
                                    <InputError className="mt-2" message={errors.due_date} />
                                </div>
